    ...
    <section id="skills" className="pt-10 pb-24">
      ...
      <div className="md:flex md:justify-between md:gap-16 mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas assumenda cupiditate
            recusandae excepturi perspiciatis rem quasi ipsam aliquid totam nostrum dolorum, veniam
            quo sequi minus.
          </p>
        </motion.div>
      ...
      <div className="md:flex md:justify-between mt-16 gap-32">
        ...
        >
          ...
          <p className="mt-5">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi necessitatibus saepe
            excepturi. Alias, nobis provident sed tempora eaque qui possimus similique eveniet
            numquam quia dolorem iste omnis repellendus inventore fugit.
          </p>
        </motion.div>
        {/* INNOVATIVE */}
        <motion.div
